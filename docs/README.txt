Channel model for ext_2G4_phy_v1
...
Where:
    ...
    * N being number of devices in the simulation
    * value = a floating point value in dB
...
is, that the coherence time of the channel is much bigger than the typical packet
length.
